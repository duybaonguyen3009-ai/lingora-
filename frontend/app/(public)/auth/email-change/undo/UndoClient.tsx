...
/**
 * UndoClient — client-only body for /auth/email-change/undo.
 *
 * Split out from page.tsx because useSearchParams() forces a CSR
 * bailout that fails Next.js 14's static prerender unless the
 * consumer is wrapped in <Suspense>. The parent page now renders
 * <Suspense fallback=...><UndoClient/></Suspense>.
 *
...
export default function UndoClient() {
