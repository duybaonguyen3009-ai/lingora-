...
export default function Hero() {
  ...
  return (
    <section className="relative rounded-lg p-7 overflow-hidden animate-fadeSlideUp animate-delay-1"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-6">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2 text-xs font-medium tracking-[1px] uppercase" style={{ color: "var(--color-accent)" }}>
            <span className="inline-block w-5 h-[1.5px]" style={{ background: "var(--color-accent)" }} />
            Good morning, Anh
          </div>

          <h2 className="font-sora font-black text-xl leading-[1.2] tracking-[-0.5px] mb-2">
            Continue where<br />you <span style={{ color: "var(--color-teal)" }}>left off</span>
          </h2>

          <div className="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-lg mb-4" style={{ background: "color-mix(in srgb, var(--color-accent) 12%, transparent)", border: "1px solid color-mix(in srgb, var(--color-accent) 20%, transparent)", color: "var(--color-accent)" }}>
          ...
          <p className="text-xs italic leading-[1.4] mb-5 max-w-[380px]" style={{ color: "var(--color-text-muted)" }}>
        ...
        <div className="flex flex-col items-center gap-3 flex-shrink-0">
          <div className="relative w-[110px] h-[110px]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="font-sora font-black text-xl leading-none" style={{ color: "var(--color-text)" }}>{progress}%</span>
              <span className="text-xs uppercase tracking-[0.5px] mt-1" style={{ color: "var(--color-text-muted)" }}>Unit progress</span>
            </div>
          </div>
          <div className="text-center">
            <div className="font-sora font-bold text-sm" style={{ color: "var(--color-text)" }}>
              Lesson {mockCourse.currentLesson} of {mockCourse.totalLessons}
            </div>
            <div className="text-xs mt-0.5" style={{ color: "var(--color-text-muted)" }}>Next: Present Perfect in Context</div>
          </div>
        </div>
      </div>
    </section>
